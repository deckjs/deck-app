...
var DEFAULT_LICENSE = 'Attribution-NonCommercial-NoDerivatives 4.0 International'
...
exports.name = processName(argv.name) || prompt('name', pkg.name, processName)

exports.author = argv.author || prompt('author', exec('npm get init.author.name') + '')

exports.license = argv.license || prompt('license', exec('npm get init.license') + '', DEFAULT_LICENSE) || DEFAULT_LICENSE
